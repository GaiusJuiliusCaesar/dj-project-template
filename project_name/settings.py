...
PYTHON_VERSION = str(MAJOR) + '.' + str(MINOR)
if (float(PYTHON_VERSION) < float(3.8)):
    raise RuntimeError(
        f"This project requires Python 3.8 or later. (Currently insatlled: Python {platform.python_version()})"
    )
...
DATABASES["default"] = dj_database_url.config(
    ...
    ssl_require=get_bool_from_env("DB_SSL", True)
)
#
